...
let double_create' ~__context  ~vM ~gPU_group ~device ~other_config ~_type ~powerstate_check =
  debug "michael: will create vgpu 0";
  let first_vgpu = create' ~__context  ~vM ~gPU_group ~device:"0" ~other_config ~_type ~powerstate_check in
  if first_vgpu = Ref.null then debug "michael: error in create first vgpu";
  debug "michael: will create vgpu 1";
  create' ~__context  ~vM ~gPU_group ~device:"1" ~other_config ~_type ~powerstate_check
 ...
 *)
let create = double_create' ~powerstate_check:true
